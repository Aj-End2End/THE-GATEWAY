    ...
    <div className="bg-custom-bg min-h-screen px-auto">
      ...
      <div className="container mx-auto sm:p-[10px] lg:p-[40px] text-[14px] text-black font-roboto">
        ...
        <p className="text-[23px] font-roboto p-[20px] text-black text-justify">
          ...
          company. We serve as trusted Channel Partners, collaborating with L&T
          Group to promote their real estate projects. Please note that our
          micro website is used for information purposes only and does not
          constitute an offer to avail of any service. Prices & discounts
          mentioned are subject to change without notice. The properties
          mentioned are subject to availability. All images are for
        ...
        <ul className="list-disc space-y-4 font-roboto text-[23px] p-[10px] text-black text-justify">
          <li>
            <a
              href="https://thegateway-sewri.southmumbai.co.in/"
              className="text-blue-500"
            >
              thegateway-sewri.southmumbai.co.in
            </a>{" "}
            ...
            <div className="col-md-12 mx-auto">
              <div className="foot_left">
                ...
                <p className="mt-4 text-base md:text-lg text-justify">
                  ...
                  of L&T Group. The content provided on this website is for
                  information purposes only and does not constitute an offer to
                  avail any service. The prices mentioned are subject to change
                  without prior notice, and the availability of properties
                  mentioned is not guaranteed. The images displayed on the
                  website are for representation purposes only and may not
                  reflect the actual properties accurately. We may share data
                  with Real Estate Regulatory Authority (RERA) registered
                  brokers/companies for further processing as required. We may
                  also send updates and information to the mobile number or
